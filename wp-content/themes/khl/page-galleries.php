				...
				<div class="container py-2">
					...
					<div class=" sort-destination-loader-loaded mt-4 pt-2">
						<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
                            ...
                            <?php while ( $gl_query->have_posts() ) : $gl_query->the_post();
                                $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'large' );
								if(!$image){
									$gallery = get_field('gallery', get_the_ID());
									$image = $gallery[0]['sizes']['large'];
								}else $image = $image[0];
                            ?>
									...
									<a href="<?php the_permalink()?>">
										<span class="thumb-info thumb-info-centered-info thumb-info-no-borders border-radius-0">
											<span class="thumb-info-wrapper border-radius-0">
												<img src="<?php echo $image; ?>" class="img-fluid border-radius-0" alt="">
