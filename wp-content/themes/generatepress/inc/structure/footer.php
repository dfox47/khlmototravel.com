	...
	function generate_construct_footer() {
		...
		<footer <?php generate_do_element_classes( 'site-info', 'site-info' ); ?>>
			...
			<div class="privacy_policy">
				<a class="lang_de_only js-popup-link" href="/de/datenschutz-bestimmungen/">Datenschutz-Bestimmungen</a>
				<a class="lang_en_only js-popup-link" href="/privacy-policy/">Privacy policy</a>
				<a class="lang_ru_only js-popup-link" href="/ru/politika-konfidenczialnosti/">Политика конфиденциальности</a>
			</div>
		</footer>
	<?php }
}
...
if ( ! function_exists( 'generate_construct_footer_widgets' ) ) {
	...
	function generate_construct_footer_widgets() {
		...
		if ( ! empty( $widgets ) && 0 !== $widgets ) :
			...
			<div id="footer-widgets" class="site footer-widgets xxxx">
