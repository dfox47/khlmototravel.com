...
class CRBSDate
{
    ...
    function formatDateToDisplay($date,$sourceFormat='d-m-Y')
    {
        ...
        return(date_format(date_create_from_format($sourceFormat,$date),CRBSOption::getOption('date_format')));
    }
    ...
    function formatTimeToStandard($time)
    {
        ...
        return(date_format(date_create_from_format(CRBSOption::getOption('time_format'),$time),'H:i'));
    }
