...
class GeneratePress_Site_Library_Rest extends WP_REST_Controller {
	...
	public function import_options( WP_REST_Request $request ) {
		...
		// To be removed prior to GP Premium 2.1.0 release.
		if ( ! isset( $existing_settings['use_dynamic_typography'] ) ) {
			$existing_settings['use_dynamic_typography'] = false;
		}

		if ( ! isset( $existing_settings['underline_links'] ) ) {
			$existing_settings['underline_links'] = 'never';
		}
